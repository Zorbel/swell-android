...
import org.waveprotocol.box.webclient.search.JsoSearchBuilderImpl;
...
/**
 * A copy of the original class {@link JsoSearchBuilderImpl} from the Apache
 * Wave. This version allow to change the request's host.
 *
 * Helper class to perform searches.
 *
 * @author vega113@gmail.com (Yuri Z.)
 */
public final class CustomJsoSearchBuilderImpl implements SearchBuilder {
  ...
  private CustomJsoSearchBuilderImpl(String host) {
    this.host = host;
  }

  /** Static factory method */
  public static SearchBuilder create(String host) {
    return new CustomJsoSearchBuilderImpl(host);
  }
